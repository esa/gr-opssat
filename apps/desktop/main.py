...
from PyQt5.QtCore import (QCoreApplication, QObject, QRunnable, QThread, pyqtSignal, QEvent, Qt, QVariant)
...
class Main(QMainWindow):
	...
	def update(self, csp, crc):
		...
		csp_crc = csp.getCRC32C()
		sent_crc = int.from_bytes(crc, byteorder='big')
