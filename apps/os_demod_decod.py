...
class os_demod_decod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.satellites_check_address_1 = satellites.check_address('DL0ESA', "to")
        ...
        self.msg_connect((self.satellites_check_address_1, 'ok'), (self.satellites_strip_ax25_header_0, 'in'))
        self.msg_connect((self.satellites_decode_rs_0, 'out'), (self.blocks_message_debug_0, 'print_pdu'))
        self.msg_connect((self.satellites_hdlc_deframer_0_0, 'out'), (self.satellites_check_address_1, 'in'))
...
def main(top_block_cls=os_demod_decod, options=None):
